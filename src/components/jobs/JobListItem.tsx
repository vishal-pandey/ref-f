...
export default function JobListItem({ job }: JobListItemProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 border rounded-lg hover:bg-muted/50 transition-colors duration-200">
      ...
      <div className="flex flex-col items-start sm:items-end sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-3 flex-shrink-0">
        {job.ReferralStatus && (
          <Badge 
        ...
        <Button asChild size="sm" className="w-full sm:w-auto sm:order-2 bg-accent hover:bg-accent/90 text-accent-foreground">
